...
var EuroToUsd = Math.round(EuroToUsd * 1000) / 1000;

console.log("For data" + " "+ euro+","+ " "+ usd +":"+ " "+euro+ " " + "euros are equal"+ " "+ EuroToUAH+ " "+ "UAH,"+ " "+ usd+ " "+ "dollars are equal"+ " "+ UsdToUAH + " "+"UAH" + ", one euro is equal"+" "+ EuroToUsd
 + " " + "dollars.");
